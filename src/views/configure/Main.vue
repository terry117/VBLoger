                    ...
                    <el-tab-pane label="基础配置" name="base" style="padding: 5px">
                        ...
                        <div v-if="!configure.useBackgroundImage">
                            ...
                            <el-form-item label="效果" prop="htmlTitle">
                                <div
                                    :style="'background-image: linear-gradient(120deg, ' + configure.backgroundColorLeft + ', ' + configure.backgroundColorRight + ');border-radius: 5px;border: 1px solid #F2F6FC;width:300px;height:100px;'">
                                    <div
                                        :style="'color: ' + configure.fontColor + ';text-align: center;padding-top:25px;font-size:35px'">
                                        <b>标题</b>
                                    </div>
                                </div>
                            </el-form-item>
                ...
                <el-form-item>
                    ...
                    <el-popover placement="top-end" width="200" trigger="click"
                        ...
                        <el-button slot="reference" icon="el-icon-question" type="text"
                            style="float: right;">说明</el-button>
                    </el-popover>
                </el-form-item>
            </el-form>
        </el-card>
...
export default {
    data() {
        return {
            ...
            rules: {
                githubUsername: [
                    //注：blur 指的是当输入框失去焦点时触发
                    //change当输入框的值发生改变时触发（适用于下拉框、选择器、切换按钮）
                    //input每次用户输入字符时触发（提供即时反馈，但通常不会用于复杂验证以避免频繁触发）
