    ...
    <div :style="'background: #f8f8f8;min-height: '+windowSize.height+'px'">
        ...
        <van-row style="background: #ffffff;" class="mobile-border">
            ...
            <van-col span="16" style="padding: 10px 10px 0px 10px">
                ...
                <br>
                <font v-if="false" style="color:#606266;font-size: 13px;line-height:13px;">粉丝&nbsp;{{followersTotal}}</font>&emsp;
                <font style="color:#606266;font-size: 13px;line-height:13px;">关注&nbsp;{{followingTotal}}</font>
            </van-col>
        </van-row>

        <van-cell class="mobile-border mobile-margin-top" title="　github.com/terry117" icon="sign" url="https://github.com/terry117"
            is-link />

        <van-cell class="mobile-border mobile-margin-top" title="　项目源码" icon="logistics" url="https://github.com/terry117/VBlog"
            is-link />
